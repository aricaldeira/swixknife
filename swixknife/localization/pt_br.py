...
class SezimalLocalePT_BR(SezimalLocalePT):
    HOLIDAYS = [
        ...
        ('EASTER-115', '🎉\ufe0f🎭\ufe0f Carnaval #𝑠𝑖𝑚'),
        # ('EASTER-114', '🎉\ufe0f🎭\ufe0f Quarta-feira de Cinzas'),
        ('EASTER-2',   '🕆\ufe0f🥀\ufe0f Paixão de Cristo #𝑠𝑖𝑚'),
        ('EASTER',     '🐣\ufe0f🌱\ufe0f Páscoa #𝑠𝑖𝑚'),
        ...
        #
        ('01-01', '🕊\ufe0f️ 🌎\ufe0f Confraternização Universal #𝑠𝑖𝑚'),
        ('05-01', '🐝\ufe0f🐜\ufe0f Dia do Trabalho #𝑠𝑖𝑚'),
        ('15-02', '🪦\ufe0f🕊\ufe0f️ Finados #𝑠𝑖𝑚'),
        ('20-40', '🥂\ufe0f🍽\ufe0f️ Véspera de Natal #𝑠𝑖𝑚'),
        ('20-41', '🌟\ufe0f👼🏼\ufe0f Natal #𝑠𝑖𝑚'),
        ('20-55', '🍾\ufe0f🎆\ufe0f Véspera de Ano Novo #𝑠𝑖𝑚'),
        ...
        #
        ('212_144-04-32', '🇧🇷\ufe0f🔺\ufe0f Tiradentes (#i) #𝑠𝑖𝑚'),                # sábado      212_144-04-32 ~ 1792-04-21_dec
        ('212_540-11-10', '🪖\ufe0f📜\ufe0f Revolução de 1932 (212󱹭540) (#i) #𝑠𝑖𝑚'),   # sábado      212_540-11-10 ~ 1932-07-09_dec
        ('212_234-13-10', '🇧🇷\ufe0f🕊\ufe0f️ Independência do Brasil (#i) #𝑠𝑖𝑚'),   # sábado      212_234-13-10 ~ 1822-09-07_dec
        ('213_100-14-22', '⛪\ufe0f👸🏾\ufe0f Nossa Senhora Aparecida (#i) #𝑠𝑖𝑚'),     # domingo      213_100-14-22 ~ 1980-10-12_dec
        ('212_425-15-31', '🇧🇷\ufe0f📜\ufe0f Proclamação da República (#i) #𝑠𝑖𝑚'),  # sexta-feira 212_425-15-31 ~ 1889-11-15_dec
        ('211_503-15-33', '👨🏾\ufe0f Consciência Negra (#i) #𝑠𝑖𝑚'),           # domingo     211_503-15-33 ~ 1695-11-20_dec
