...
class SezimalLocalePT_BR(SezimalLocalePT):
    _HOLIDAYS = [
        ...
        #
        # ('13_0332-04-32', '\ufe0f🇧🇷🔺 Tiradentes'),                # sábado      13_0332-04-32 ~ 1792-04-21_dec
        # ('13_1124-11-10', '\ufe0f🪖📜 Revolução de 1932 (3̇1̇4̈)'),   # sábado      13_1124-11-10 ~ 1932-07-09_dec
        # ('13_0422-13-10', '\ufe0f🇧🇷🕊️  Independência do Brasil'),  # sábado      13_0422-13-10 ~ 1822-09-07_dec
        # ('13_1013-15-31', '\ufe0f🇧🇷📜 Proclamação da República'),  # sexta-feira 13_1013-15-31 ~ 1889-11-15_dec
        # ('13_0051-15-33', '\ufe0f👨🏿 Consciência Negra'),            # domingo    13_0051-15-33 ~ 1695-11-20_dec

        ('13_0332-04-33', '\ufe0f🇧🇷🔺 Tiradentes'),                     # domingo,       04-33 ~ 04-21_dec
        ('13_1124-11-13', '\ufe0f🪖📜 Revolução de 1932 (3̇1̇4̈) (#i)'),   # terça-feira,   11-13 ~ 07-09_dec
        ('13_0422-13-11', '\ufe0f🇧🇷🕊️  Independência do Brasil (#i)'),  # domingo,       13-11 ~ 09-07_dec
        ('13_1013-15-23', '\ufe0f🇧🇷📜 Proclamação da República (#i)'),  # segunda-feira, 15-23 ~ 11-15_dec
        ('13_0051-15-32', '\ufe0f👨🏿 Consciência Negra'),                # sábado,        15-32 ~ 11-20_dec
    ]
    ...
    HOLIDAYS_OTHER_CALENDAR = [
        ...
        #
        ('ISO-1792-04-21', '\ufe0f🇧🇷🔺 Tiradentes (%d/%m)'),                     # sábado      13_0332-04-32 ~ 1792-04-21_dec
        ('ISO-1932-07-09', '\ufe0f🪖📜 Revolução de 1932 (3̇1̇4̈) (%d/%m - %i)'),   # sábado      13_1124-11-10 ~ 1932-07-09_dec
        ('ISO-1822-09-07', '\ufe0f🇧🇷🕊️  Independência do Brasil (%d/%m - %i)'),  # sábado      13_0422-13-10 ~ 1822-09-07_dec
        ('ISO-1889-11-15', '\ufe0f🇧🇷📜 Proclamação da República (%d/%m - %i)'),  # sexta-feira 13_1013-15-31 ~ 1889-11-15_dec
        ('ISO-1695-11-20', '\ufe0f👨🏿 Consciência Negra (%d/%m)'),                # domingo     13_0051-15-33 ~ 1695-11-20_dec
    ]
