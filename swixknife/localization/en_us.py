...
class SezimalLocaleEN_US(SezimalLocaleEN):
    ...
    HOLIDAYS = [
        ...
        ('212_120-11-04', '🇺\ufe0f🇸\ufe0f Independence Day (#i) #Sym454'),  # Thursday 212_120-11-04 ~ 1776-07-04_dec
        ('10-31', '🇺\ufe0f🇸\ufe0f Juneteenth Day #Sym454'),
        ('14-44', '🎃\ufe0f🍬\ufe0f Halloween #Sym454'),
        ('15-15', '🇺\ufe0f🇸\ufe0f Veterans’ Day #Sym454'),
        ...
        #
        ('01-23', '🇺\ufe0f🇸\ufe0f Martin Luther King, Jr. Day #Sym454'), # Monday, the 23rd of Jan. ~ Monday, the 15th of Jan.
        # ('01-32', 'Inauguration Day'),
        ('02-23', '🇺\ufe0f🇸\ufe0f Presidents’ Day #Sym454'),   # Third Monday in February
        ('05-45', '🇺\ufe0f🇸\ufe0f Memorial Day #Sym454'),      # Last Monday in May
        ('13-01', '🐝\ufe0f Labour Day #Sym454'),        # First Monday in September
        ('14-12', '🇺\ufe0f🇸\ufe0f Columbus Day #Sym454'),      # Second Monday in October
    ...
    HOLIDAYS_OTHER_CALENDAR = [
        ...
        ('ISO-1776-07-04', '🇺\ufe0f🇸\ufe0f Independence Day (%i)'),  # Thursday 130_304-11-04 ~ 1776-07-04_dec
        ('ISO-06-19', '🇺\ufe0f🇸\ufe0f Juneteenth Day'),
        ('ISO-10-31', '🎃\ufe0f🍬\ufe0f Halloween'),
        ('ISO-11-11', '🇺\ufe0f🇸\ufe0f Veterans’ Day'),
        ...
        # that occur on a specific weekday
        #
        ('ISO-01-01+MON_3', '🇺\ufe0f🇸\ufe0f Martin Luther King, Jr. Day'), # Monday, the 23rd of Jan. ~ Monday, the 15th of Jan.
        # ('01-32', 'Inauguration Day'),
        ('ISO-02-01+MON_3', '🇺\ufe0f🇸\ufe0f Presidents’ Day'),   # Third Monday in February
        ('ISO-05-31-MON', '🇺\ufe0f🇸\ufe0f Memorial Day'),      # Last Monday in May
