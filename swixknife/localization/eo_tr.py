...
class SezimalLocaleEO_TR(SezimalLocaleEO):
    ...
    HOLIDAYS = [
        ...
        ('212_511-03-15', '🇹🇷\ufe0f🛑\ufe0f Memortago de Martiroj kaj la Venko de Ĉanakale (#i)'),
        ('212_520-04-31', '🇹🇷\ufe0f👧\ufe0f Tago de Infanoj kaj Nacia Suvereneco (#i)'),
        ('212_515-05-34', '🇹🇷\ufe0f Tago de Junularo, Memoro de Atatürk kaj Sporto (#i)'),
        ('213_200-11-20', '🇹🇷\ufe0f🕊️\ufe0f Tago de Demokratio kaj Nacia Unueco (#i)'),
        ('212_522-12-51', '🇹🇷\ufe0f🏆\ufe0f Venktago (#i)'),
        ('212_523-15-01', '🇹🇷\ufe0f🎇\ufe0f Tago de la Respubliko (#i)'),
        ('212_550-15-15', '🇹🇷\ufe0f🫡\ufe0f Memortago de Atatürk (#i)'),
