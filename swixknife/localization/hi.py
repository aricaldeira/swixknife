...
class SezimalLocaleHI(SezimalLocale):
    ...
    HOLIDAYS = [
        ...
        #
        ('213010-01-41', '🇮🇳\ufe0f गणतन्त्र दिवस (#i) #Sym454'),
        ('213003-12-31', '🇮🇳\ufe0f स्वतंत्रता दिवस (#i) #Sym454'),
        ('212353-13-43', '🇮🇳\ufe0f👳🏽‍♂️ गांधी जयंती (#i) #Sym454'),
    ]
    ...
    HOLIDAYS_OTHER_CALENDAR = [
        ...
        # that occur on a specific date
        #
        ('ISO-1950-01-26', '🇮🇳\ufe0f गणतन्त्र दिवस (%i)'),
        ('ISO-1947-08-15', '🇮🇳\ufe0f स्वतंत्रता दिवस (%i)'),
        ('ISO-1869-10-02', '🇮🇳\ufe0f👳🏽‍♂️ गांधी जयंती (%i)'),
    ]
