...
'''
    ...
    CHRISTIAN_HOLIDAYS = [
        ...
        ('CHR+SYM+01-01',     '🕆\ufe0f Solemnity of Mary, Mother of God #𝑠𝑦𝑚'),
        ('CHR+SYM+01-06',     '🕆\ufe0f Epiphany #𝑠𝑦𝑚'),
        ('CHR+SYM+01-06+SUN', '🕆\ufe0f Baptism of the Lord #𝑠𝑦𝑚'),
        ('CHR+SYM+02-02',     '🕆\ufe0f Candlemas #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-124', '🕆\ufe0f Fat Thursday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-120', '🕆\ufe0f Shrove Monday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-115', '🕆\ufe0f Shrove Tuesday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-114', '🕆\ufe0f Ash Wednesday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-11',  '🕆\ufe0f Palm Sunday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-4',   '🕆\ufe0f Holy Wednesday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-3',   '🕆\ufe0f Maundy Thursday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-2',   '🕆\ufe0f🥀\ufe0f Good Friday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER-1',   '🕆\ufe0f Holy Saturday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER',     '🕆\ufe0f🐣\ufe0f🌱\ufe0f Easter #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+1',   '🕆\ufe0f Easter Monday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+11',  '🕆\ufe0f Divine Mercy Sunday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+103', '🕆\ufe0f Ascension of Jesus #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+121', '🕆\ufe0f Pentecost #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+122', '🕆\ufe0f Whit Monday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+132', '🕆\ufe0f🛆 Trinity Sunday #𝑠𝑦𝑚'),
        ('CHR+SYM+EASTER+140', '🕆\ufe0f🥖\ufe0f🍷\ufe0f Corpus Christi #𝑠𝑦𝑚'),
        ('CHR+SYM+11-01',      '🕆\ufe0f All Saint’s #𝑠𝑦𝑚'),
        ('CHR+SYM+11-02',      '🕆\ufe0f All Soul’s #𝑠𝑦𝑚'),
        ('CHR+SYM+12-25-SUN_4','🕆\ufe0f Advent #𝑠𝑦𝑚'),
        ('CHR+SYM+12-25',      '🕆\ufe0f🌟\ufe0f👼🏼\ufe0f Christmas #𝑠𝑦𝑚'),
    ]
