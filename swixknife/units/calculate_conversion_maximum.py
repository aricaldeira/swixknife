...
# Gravity
#
GRAVITY = SezimalFraction('34_151_110_011_300 / 2_135_230_542_125')

#
# Density of water at 277.129_966_947_643_dec K
#
# from iapws.iapws95 import IAPWS95
# water = IAPWS95(T=277.129_966_947_643, P=0.101325)
# print(water.rho)
# 999.974_872_928_444_600
#
DENSITY = SezimalFraction('121_121_502_323_543_553_131 / 14_344_545_052_312_052')

#
# Specific heat of water at 277.129_966_947_643_dec K
#
# from iapws.iapws95 import IAPWS95
# water = IAPWS95(T=277.129_966_947_643, P=0.101325)
# print(water.cp * 1000)
# 4207.553_885_519_104_578
#
# This exact value gives a conversion between K and gkt
#      273.15_dec K = 240_444_432.3 (4_516_292.5_dec) gtk
# exactly, and the conversion between gkt and tap
#      tap = (gtk - 240_444_432.3) / 100_000
#
SPECIFIC_HEAT = SezimalFraction('235_522_344_041_202_401_100_333 / 4_531_224_455_021_434_452')
...
def calculate_conversions():
    ...
    GATIKA_TO_KELVIN = SezimalFraction('41_143 / 12_543_555_122')
